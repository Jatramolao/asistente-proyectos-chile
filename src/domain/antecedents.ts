...
export const ANTECEDENT_DEFINITIONS = [
  { key: "essence.problem", section: "essence", label: "Problema u oportunidad", help: "Qué situación relevante quieres cambiar.", valueType: "long_text", decisive: false },
  ...
  { key: "essence.solution", section: "essence", label: "Solución propuesta", help: "Cómo funcionaría la solución que imaginas.", valueType: "long_text", decisive: false },
  ...
  { key: "essence.customer", section: "essence", label: "Cliente o beneficiario", help: "Quién usaría, compraría o recibiría el beneficio.", valueType: "short_text", decisive: false },
  ...
  { key: "technology.component", section: "technology", label: "Componente tecnológico", help: "Tecnología que habilita la solución.", valueType: "long_text", decisive: true },
  { key: "technology.novelty", section: "technology", label: "Novedad frente a alternativas", help: "Qué mejora relevante aporta sobre lo existente.", valueType: "long_text", decisive: true },
  ...
  { key: "applicant.formalization", section: "applicant", label: "Situación de formalización", help: "Persona natural o empresa constituida.", valueType: "status", decisive: true },
